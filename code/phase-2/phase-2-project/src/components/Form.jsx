...
const Form = ({logsUpdate}) => {
	...
	const { name, activity, date, location, state, description, notes } =
		formData;
        ...
        const handleSubmitExperience = (e) => {
            ...
            fetch("http://localhost:3000/data", {
                ...
                .then((res) => res.json())
                .then((updateExperiences) => console.log(updateExperiences));
	...
	return (
		<div>
			...
			<form onSubmit={handleSubmitExperience} className="experience-form">
